...
public final
class CreateAVmWithADiffOsDiskUsingDiffDiskPlacementAsCacheDisk {
    /*
     * operationId: VirtualMachines_CreateOrUpdate
     * api-version: 2021-04-01
     * x-ms-examples: Create a vm with ephemeral os disk provisioning in Cache disk using placement property.
     */
    /**
