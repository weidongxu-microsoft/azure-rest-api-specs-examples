...
public final
class CreateAWindowsVmWithPatchSettingModeOfAutomaticByPlatformAndEnableHotPatchingTrue {
    /*
     * operationId: VirtualMachines_CreateOrUpdate
     * api-version: 2021-04-01
     * x-ms-examples: Create a Windows vm with a patch setting patchMode of AutomaticByPlatform and enableHotpatching set to true.
     */
    /**
