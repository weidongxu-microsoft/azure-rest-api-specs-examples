...
public final
class CreateAVmWithADiffOsDiskUsingDiffDiskPlacementAsResourceDisk {
    /*
     * operationId: VirtualMachines_CreateOrUpdate
     * api-version: 2021-04-01
     * x-ms-examples: Create a vm with ephemeral os disk provisioning in Resource disk using placement property.
     */
    /**
