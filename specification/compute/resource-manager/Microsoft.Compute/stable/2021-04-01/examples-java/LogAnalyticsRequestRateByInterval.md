...
public final
class LogAnalyticsRequestRateByInterval {
    /*
     * operationId: LogAnalytics_ExportRequestRateByInterval
     * api-version: 2021-04-01
     * x-ms-examples: Export logs which contain all Api requests made to Compute Resource Provider within the given time period broken down by intervals.
     */
    /**
