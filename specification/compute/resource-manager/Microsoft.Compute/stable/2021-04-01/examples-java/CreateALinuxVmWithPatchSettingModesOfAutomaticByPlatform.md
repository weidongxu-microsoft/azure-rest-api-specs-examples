...
public final
class CreateALinuxVmWithPatchSettingModesOfAutomaticByPlatform {
    /*
     * operationId: VirtualMachines_CreateOrUpdate
     * api-version: 2021-04-01
     * x-ms-examples: Create a Linux vm with a patch settings patchMode and assessmentMode set to AutomaticByPlatform.
     */
    /**
