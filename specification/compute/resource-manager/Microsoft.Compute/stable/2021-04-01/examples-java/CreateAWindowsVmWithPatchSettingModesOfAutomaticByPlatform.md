...
public final
class CreateAWindowsVmWithPatchSettingModesOfAutomaticByPlatform {
    /*
     * operationId: VirtualMachines_CreateOrUpdate
     * api-version: 2021-04-01
     * x-ms-examples: Create a Windows vm with patch settings patchMode and assessmentMode set to AutomaticByPlatform.
     */
    /**
