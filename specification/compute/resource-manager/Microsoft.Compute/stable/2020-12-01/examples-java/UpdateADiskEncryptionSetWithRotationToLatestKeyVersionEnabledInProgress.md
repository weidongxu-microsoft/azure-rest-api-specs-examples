...
public final
class UpdateADiskEncryptionSetWithRotationToLatestKeyVersionEnabledInProgress {
    /*
     * operationId: DiskEncryptionSets_Update
     * api-version: 2020-12-01
     * x-ms-examples: Update a disk encryption set with rotationToLatestKeyVersionEnabled set to true - Updating
     */
    /**
