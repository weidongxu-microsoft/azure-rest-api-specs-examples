...
public final class CreateAManagedDiskByImportingAnUnmanagedBlobFromTheSameSubscription {
    /*
     * operationId: Disks_CreateOrUpdate
     * api-version: 2020-12-01
     * x-ms-examples: Create a managed disk by importing an unmanaged blob from the same subscription.
     */
    /**
