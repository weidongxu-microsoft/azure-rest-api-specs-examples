...
public final
class CreateOrUpdateASimpleGalleryImageVersionWithImageVersionAsSource {
    /*
     * operationId: GalleryImageVersions_CreateOrUpdate
     * api-version: 2020-09-30
     * x-ms-examples: Create or update a simple Gallery Image Version using shared image as source.
     */
    /**
